...
:page-description: Learn how to use various MicroProfile Reactive Messaging acknowledgement strategies to acknowledge messages.
...
MicroProfile Reactive Messaging acknowledgement consists of the following main concepts:
